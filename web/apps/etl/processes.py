...
class ETLProcessing:
    ...
    def load_last_night(self, hours=14, time_stop="12:00:00", tess_type='W'):
    ...
    def load_last_week(self, days=7, time_stop="12:00:00", tess_type='W'):
        ...
        for item in result_json:
            try:
                ...
                print("Tess:" +tess_id)
                pass
        self.__log.info("End Load last week")

    def load_last_month(self, days=30, time_stop="12:00:00", tess_type='W'):
        ...
        for item in result_json:
            try:
                ...
                print("Tess:" +tess_id)
                pass
        self.__log.info("End Load last month")
    ...
    def light_pollution_indicator(self):
        ...
        for item in result_json:
            try:
                ...
                tessw=TessW.objects.get(id=tess_id)
                tessw.median_magnitude=median_magnitude
                tessw.start_time_median_magnitude=start_time_median_magnitude
                tessw.stop_time_median_magnitude=stop_time_median_magnitude
                tessw.bortle_level = scale[np.digitize(median_magnitude, ranges) - 1]
                tessw.save()
            except Exception as e:
                print(e)
                print("Tess:" +tess_id)
                pass
        self.__log.info("End Load last night")
    ...
    def historical_bortle(self, from_date, to_date, now, period):
        ...
        for item in result_json:
            try:
                ...
                tessw.bortle_level = scale[np.digitize(median_magnitude, ranges) - 1]
                tessw.save()
                hitorical_values, created = HistoricalValuesTessW.objects.get_or_create(tess=tessw, day=period.day, month=period.month, year=period.year, calculation_date=now)
                ...
                print("Tess:" +tess_id)
                pass
        self.__log.info("End Load historical bortle")
    ...
    def historical_stddev_magnitude(self, from_date, to_date, now, period):
        ...
        for item in result_json:
            try:
                ...
                print("Tess:" +tess_id)
                pass
        self.__log.info("End Load historical stddev magnitude")
    ...
    def historical_median_magnitude_clear(self, from_date, to_date, now, period):
        ...
        for item in result_json:
            try:
                ...
                print("Tess:" +tess_id)
                pass
        self.__log.info("End Load historical median magnitude clear")
    ...
    def historical_stddev_magnitude_clear(self, from_date, to_date, now, period):
        ...
        for item in result_json:
            try:
                ...
                print("Tess:" +tess_id)
                pass
        self.__log.info("End Load historical stddev magnitude clear")
    ...
    def historical_median_magnitude_covered(self, from_date, to_date, now, period):
        ...
        for item in result_json:
            try:
                ...
                print("Tess:" +tess_id)
                pass
        self.__log.info("End Load historical median magnitude covered")
    ...
    def historical_median_magnitude_cloudy(self, from_date, to_date, now, period):
        ...
        for item in result_json:
            try:
                ...
                print("Tess:" +tess_id)
                pass
        self.__log.info("End Load historical median magnitude cloudy")
    ...
    def historical_total_measurements_month(self, from_date, to_date, now, period):
        ...
        for item in result_json:
            try:
                ...
                print("Tess:" +tess_id)
                pass
        self.__log.info("End Load historical total measurements month")
    ...
    def historical_total_measurements_month_clear(self, from_date, to_date, now, period):
        ...
        for item in result_json:
            try:
                ...
                print("Tess:" +tess_id)
                pass
        self.__log.info("End Load historical total measurements month clear nights")
    ...
    def historical_total_measurements_month_covered(self, from_date, to_date, now, period):
        ...
        for item in result_json:
            try:
                ...
                print("Tess:" +tess_id)
                pass
        self.__log.info("End Load historical total measurements month covered nights")
    ...
    def historical_total_measurements_month_cloudy(self, from_date, to_date, now, period):
        ...
        for item in result_json:
            try:
                ...
                print("Tess:" +tess_id)
                pass
        self.__log.info("End Load historical total measurements month cloudy nights")
    ...
    def get_month_data(self, tess, from_date, to_date, now, period):
        ...
        if response.status_code == 200:
            if len(response.text)>4:
                with open(f'{period.day}_{period.month}_{period.year}_{tess}.csv', 'w') as file:
    ...
    def upload_month_data_by_date(self, from_date, to_date, now, period):
        ...
        tessws=TessW.objects.all()
        for tessw in tessws:
            try:
                file=self.get_month_data(tessw.id, from_date, to_date, now, period)
                if file:
                    ...
                    hitorical_values, created = HistoricalValuesTessW.objects.get_or_create(tess=tessw, day=period.day, month=period.month, year=period.year)
                ...
                self.__log.error(f"Error con create csv file {tessw}")
    ...
    def upload_month_data_by_id(self, from_date, to_date, now, period):
        ...
        tessws=TessW.objects.all()
        for tessw in tessws:
            s3_folder=f"{base_folder}/{tessw.id}/"
            self.create_folder_s3(s3, s3_folder)
            try:
                file=self.get_month_data(tessw.id, from_date, to_date, now, period)
                if file:
